...
def query(Smoke:str, Alcohol: str, level: str) -> str:
    ...
    openai.api_key="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"
    template = f"""
    ...
    response = openai.ChatCompletion.create(
        ...
        temperature = 0,
        messages=[
        {"role": "system", "content": f"You are a good health coach lung cancer, give concise advice and guideline to help patient\
         who {Smoke} and {Alcohol} and his lung cancer risk is {level} within 80 words."},
